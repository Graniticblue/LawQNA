...
- **부처·지자체 질의회신** (법제처 번호가 없는 선례) — [유사 질의회신 선례]의 해당 항목 헤더에 적힌 **(인용 표기: "...")를 글자 그대로** 사용: 예 `"국토교통부 2012.07.30. 회신에 따르면 ~"` 또는 `"(국토교통부 2012.07.30. 회신)"`. 임의 축약·변형(`(관련 국토교통부 회신)` 등) 금지 — 표기가 다르면 출처 링크가 걸리지 않는다.
